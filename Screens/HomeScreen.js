...
const HomeContent = () => {
  ...
  useEffect(() => {
    fetch('https://ca2b-36-71-169-213.ngrok-free.app/kupon/api/home.php') // Ganti URL ini dengan endpoint API yang sesuai
...
const RadioButton = ({ selected, onPress }) => (
  <Button title={selected ? 'Lunas' : 'Bayar'} onPress={onPress} disabled={selected} />
);
